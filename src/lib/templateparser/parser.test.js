...
test('Parse template with inner content as a string', (assert) => {
  const template = `<Element>Inner content</Element>`
...
test('Parse template with inner content as a string with extra whitespace', (assert) => {
...
test('Parse template with inner content in a nested element', (assert) => {
  const template = `<Element>
    <Element>
          Inner content
          </Element>
...
test('Parse template with dynamic inner content', (assert) => {
  const template = `<Text>{{$myText}}</Text>`
