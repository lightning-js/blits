...
test('Setting prop value directly', (assert) => {
  ...
  assert.equal(logs[1].args.pop(), `Warning! Avoid mutating props directly (prop "${props[0].key}" in component "${componentInstance.componentId}")`, 'Should log warning message')
